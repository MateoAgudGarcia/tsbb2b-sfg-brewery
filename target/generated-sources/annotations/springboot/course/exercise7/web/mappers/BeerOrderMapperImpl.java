...
import springboot.course.exercise7.domain.BeerOrder.BeerOrderBuilder;
...
import springboot.course.exercise7.web.model.BeerOrderDto.BeerOrderDtoBuilder;
import springboot.course.exercise7.web.model.BeerOrderLineDto;
import springboot.course.exercise7.web.model.BeerOrderLineDto.BeerOrderLineDtoBuilder;
...
public class BeerOrderMapperImpl implements BeerOrderMapper {
    ...
    protected springboot.course.exercise7.web.model.OrderStatusEnum orderStatusEnumToOrderStatusEnum(OrderStatusEnum orderStatusEnum) {
        if ( orderStatusEnum == null ) {
            return null;
        }

        springboot.course.exercise7.web.model.OrderStatusEnum orderStatusEnum1;

        switch ( orderStatusEnum ) {
            case NEW: orderStatusEnum1 = springboot.course.exercise7.web.model.OrderStatusEnum.NEW;
            break;
            case READY: orderStatusEnum1 = springboot.course.exercise7.web.model.OrderStatusEnum.READY;
            break;
            case PICKED_UP: orderStatusEnum1 = springboot.course.exercise7.web.model.OrderStatusEnum.PICKED_UP;
            break;
    ...
    protected OrderStatusEnum orderStatusEnumToOrderStatusEnum1(springboot.course.exercise7.web.model.OrderStatusEnum orderStatusEnum) {
        if ( orderStatusEnum == null ) {
            return null;
        }
